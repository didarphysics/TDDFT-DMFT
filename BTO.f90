...
!    open(1,File='data/dipole.dat')
  ...
  !  read(1,*) dipole_0(m,l,m1,l1,i,1)
  !  read(1,*) dipole_0(m,l,m1,l1,i,2)
  !  read(1,*) dipole_0(m,l,m1,l1,i,3)
...
!             write(*,*) 'w',omega,'phi',phi,I_int(i)
        ...
        i=11*omega0/(4.0d0*pi*delta_omega)

        i4=12*omega0/(4.0d0*pi*delta_omega)

        write(14,*) (phi/pi)*180.0d0, I_int(i), I_int(i4)
